...
Welcome to limetta's Hytale API Documentation! We've been working on a Hytale server with our own plugins, and during this we've had to dig through the decompiled HytaleServer to figure out the API. These docs are written based on our findings.

The documentation here is:
- Based on decompiled code from HytaleServer
- Investigated and written by Claude Opus

As with any AI content, please take it with a grain of salt. However, we try to make sure that this documentation can be as accurate and free of hallucinations as possible:
...
- We use this documentation ourselves to make our own plugins.
